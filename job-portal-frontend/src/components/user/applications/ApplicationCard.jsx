...
export const STATUS_CONFIG = {
  PENDING:             { label: "Pending",             color: "bg-cyan-100 text-cyan-700",    icon: Clock },
  REVIEWING:           { label: "Under Review",        color: "bg-yellow-100 text-yellow-700", icon: AlertCircle },
  SHORTLISTED:         { label: "Shortlisted",         color: "bg-teal-100 text-teal-800",     icon: CheckCircle2 },
  INTERVIEW_SCHEDULED: { label: "Interview Scheduled", color: "bg-teal-50 text-teal-700",      icon: CheckCircle2 },
