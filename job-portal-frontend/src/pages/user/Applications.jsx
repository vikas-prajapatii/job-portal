  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        <StatCard label="Total Applied"   value={stats.total}       icon={Briefcase}    color="text-brand bg-cyan-50" />
        <StatCard label="Active"          value={stats.active}      icon={TrendingUp}   color="text-brand bg-cyan-100/50" />
        <StatCard label="Shortlisted"     value={stats.shortlisted} icon={CheckCircle2} color="text-teal-600 bg-teal-50" />
